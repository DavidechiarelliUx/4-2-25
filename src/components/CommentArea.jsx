...
class CommentArea extends Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            const headers = { Authorization : "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2N2E0YzNmOWNhMDcwNDAwMTU4YmY5MmMiLCJpYXQiOjE3Mzg4NTEzMjEsImV4cCI6MTc0MDA2MDkyMX0.8rd3Aqp_mu4Zua5wBkFOEA4m1EH5-AMKFfxIAr06JCc"}
